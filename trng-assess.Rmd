...
Another useful way to phrase test questions is to write a list of statements that probe a definition or protocol from different angles and to ask trainees to select all the correct or wrong statements.
